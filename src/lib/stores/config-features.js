export const config = {
	mapTitle: 'map-young-european-parents', // The title of the map, if more than one word, separate by dash, e.g. "income-europe"
	vercelURL: 'https://map-young-europeans-parents.vercel.app/', // The url provided when deploying the map on Vercel
